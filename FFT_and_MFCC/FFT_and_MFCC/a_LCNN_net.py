...
class Net(nn.Module):
    def __init__(self):
        ...
        self.all_layer = nn.Sequential(
            # 1
            nn.Conv2d(1, 32, kernel_size=5, stride=(1, 1), padding=2),  # input，output, kernel   # 32
        ...
        nn.init.xavier_normal_(self.all_layer[26].weight)
        nn.init.xavier_normal_(self.all_layer[28].weight)
...
class Net3(nn.Module):
    def __init__(self):
        ...
        self.all_layer = nn.Sequential(
        nn.Conv2d(1, 32, kernel_size=(5, 5), stride=(1, 3)),
        ...
        nn.MaxPool3d(kernel_size=(2, 1, 1), stride=(2, 1, 1), padding=0, dilation=1, ceil_mode=False),
        nn.Conv2d(16, 48, kernel_size=(3, 3), stride=(1, 1)),
        nn.MaxPool3d(kernel_size=(2, 1, 1), stride=(2, 1, 1), padding=0, dilation=1, ceil_mode=False),
        nn.MaxPool2d(kernel_size=2, stride=2, padding=0, dilation=1, ceil_mode=False),
        nn.BatchNorm2d(24, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True),
        nn.Dropout2d(p=0.5, inplace=False),

        nn.Conv2d(24, 48, kernel_size=(1, 1), stride=(1, 1)),
        nn.MaxPool3d(kernel_size=(2, 1, 1), stride=(2, 1, 1), padding=0, dilation=1, ceil_mode=False),
        nn.Conv2d(24, 64, kernel_size=(3, 3), stride=(1, 1)),
        nn.MaxPool3d(kernel_size=(2, 1, 1), stride=(2, 1, 1), padding=0, dilation=1, ceil_mode=False),
        nn.MaxPool2d(kernel_size=3, stride=(1, 2), padding=0, dilation=1, ceil_mode=False),
