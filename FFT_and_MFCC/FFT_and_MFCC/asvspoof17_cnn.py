...
from simple_load.FFT_and_MFCC.asv2017_Dataset import ASVspoofTestData, ASVspoofTrainData, ASVspoofDevData
from simple_load.FFT_and_MFCC.a_LCNN_net import Net3

'''lcnn for 167*400 fft and mfcc'''
...
# model = Net3()
model_path = 'a_lcnn_iter{}_mfcc2.mdl'.format(36)
...
# scheduler = lr_scheduler.StepLR(step_size=60, optimizer=optimizer, gamma=0.5)
...
if args.train:
    for epoch in range(41, 40+args.epochs+1):
        train(epoch)
        # scheduler.step()
